    ...
    public static class ProductHelpers
    {
        ...
        {int column = 1;
            ...
            foreach (var article in department)
            {
                ...
                if (HttpContext.Current.Request.Cookies["mtAddAccount"] != null && HttpContext.Current.Request.Cookies["mtAddAccount"].Value != "0")
                { mycart = GeneralMethods.Button("/Store/AddPosition/" +HttpContext.Current.Request.Cookies["mtAddAccount"].Value+"/"+ article.ProductId, StoreLanguage.addaccount, false, "right"); }
                string checkeds = (HttpContext.Current.Request.Cookies["mtProductComparison"] != null
                 && HttpContext.Current.Request.Cookies["mtProductComparison"].Value.Contains(string.Format("[{0}]", article.ProductId)))
                ? "checked=\"checked\""
                : string.Empty;

                string cart = (HttpContext.Current.Request.Cookies["mtProductCart"] != null
                    && HttpContext.Current.Request.Cookies["mtProductCart"].Value.Contains(string.Format("_{0}_", article.ProductId)))
                ? "checked=\"checked\""
                : string.Empty;
                ...
                if(article.Price>0)
                    ...
                    + "_1' class='cart' /> <label for='cart" + article.ProductId+"'>" + string.Format(StoreLanguage.cart, "<a href='/Store/Cart/" + article.ProductId + "'>" + StoreLanguage.cart2 + "</a>")+"</label>";
        ...
        public static HtmlString ViewProduct(this HtmlHelper html, mytrip_storeproduct x)
        {
            ...
            string checkeds = (HttpContext.Current.Request.Cookies["mtProductComparison"] != null
                 && HttpContext.Current.Request.Cookies["mtProductComparison"].Value.Contains(string.Format("[{0}]", x.ProductId)))
                ? "checked=\"checked\""
                : string.Empty;

            string cart = (HttpContext.Current.Request.Cookies["mtProductCart"] != null
                && HttpContext.Current.Request.Cookies["mtProductCart"].Value.Contains(string.Format("_{0}_", x.ProductId)))
            ? "checked=\"checked\""
            : string.Empty;
            string storecart = "";
            if(x.Price>0)
            ...
            string comparision = "<br/><input " + checkeds + " type='checkbox' id='compar" + x.ProductId
                + "' value='" + x.ProductId
                + "' class='comparision' /> <label for='compar"+ x.ProductId+"'>" + string.Format(StoreLanguage.compare, "<a href='/Store/View/0/Comparision'>" + StoreLanguage.compare2 + "</a></label>");
            string saleprice = "<br/>";
            int sale1 = 0;
            DateTime saledate = DateTime.Now;
            //Отображение скидки для отдела
            ...
            if (HttpContext.Current.Request.Cookies["mtAddAccount"] != null && HttpContext.Current.Request.Cookies["mtAddAccount"].Value != "0")
            { mycart = GeneralMethods.Button("/Store/AddPosition/" + HttpContext.Current.Request.Cookies["mtAddAccount"].Value + "/" + x.ProductId, StoreLanguage.addaccount, false, "right"); }
        ...
        public static string ViewProduct(mytrip_storeproduct x,int content,int imgwidth)
        {
            ...
            if (HttpContext.Current.Request.Cookies["mtAddAccount"] != null && HttpContext.Current.Request.Cookies["mtAddAccount"].Value != "0")
            { mycart = GeneralMethods.Button("/Store/AddPosition/" + HttpContext.Current.Request.Cookies["mtAddAccount"].Value + "/" + x.ProductId, StoreLanguage.addaccount, false, "left"); }

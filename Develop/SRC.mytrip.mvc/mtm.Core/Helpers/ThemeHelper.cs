...
namespace mtm.Core.Helpers
{
    ...
    public static class ThemeHelper
    {
        ...
        public static HtmlString CssLink(this HtmlHelper html)
        {
            ...
            if (ThemeSetting.wrap() == "mtm.Core.Wrap.YesWrapRes")
            link.MergeAttribute("href", "/Theme/" + ThemeSetting.theme() + "/WrapSite.css");
            else
        ...
        public static HtmlString ScriptLink(this HtmlHelper html, string filename)
        {
            ...
            {
                string _x = x.Trim();
                if (ThemeSetting.wrap() == "mtm.Core.Wrap.YesWrapRes" && _x == "mtm.Include.js")
                    _x = "mtm.IncludeWrap.js";

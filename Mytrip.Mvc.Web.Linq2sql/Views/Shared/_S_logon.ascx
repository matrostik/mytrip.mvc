...
%>
       ...
       <div class="log_a">
<div class="log_a1"></div>
<div class="log_a2"></div><div class="log_gr"><%= Html.ActionLink("выход", "F", "B") %></div></div>
        <div class="log_a">
<div class="log_a1"></div>
<div class="log_a2"></div><div class="log_gr"><%= Html.ActionLink("сменить пароль", "C", "B")%></div></div>
<%
    }
    else
    {
...
%> 
        ...
        <div class="log_a">
<div class="log_a1"></div>
<div class="log_a2"></div><div class="log_gr"><%if(captcha==false){ %> <%= Html.ActionLink("регистрация", "B", "B")%><%}else{%> <%= Html.ActionLink("регистрация", "H", "B")%><%} %></div></div>
<div class="log_a">
<div class="log_a1"></div>
<div class="log_a2"></div><div class="log_gr"><a href="<%=Url.Action("A", "B", new { returnUrl = urla})%>">вход</a></div></div>

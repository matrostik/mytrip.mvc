...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
	<%= ViewData["model_domain"]%>/Редактировать новость
</asp:Content>
...
Менеджер файлов</a>
          ...
          <p>
                ...
                <%= Html.CheckBox("Warning")%><label for="Warning">Выделить цветом?</label>
	...
	<p>
         ...
         <p>
                ...
                <%= Html.DropDownList("b", (IEnumerable<SelectListItem>)ViewData["Category"])%>                
            </p>

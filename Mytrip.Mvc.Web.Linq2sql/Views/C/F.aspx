...
<!--/*   Mytrip.Mvc.Web.Linq2sql   Copyright ©  2009 Стюхин Олег Анатольевич   */-->
    ...
    <%int cat = (int)ViewData["count_canegory"];
      ...
      {%><div class="edit_content">
          рубрика новостей: <a href="<%=Url.Action("ZE", "Artycle")%>"><img src="/content/images/create.png" alt="создать" style="border-width: 0px;" /></a>
      </div>
    <br />
    <br />
    <%if (cat > 0)
      { %>
    <div class="edit_content">
        новость: <a href="<%=Url.Action("ZW", "C", new { a = 0 })%>"><img src="/content/images/create.png" alt="создать" style="border-width: 0px;" /></a>
    </div>
    <%}

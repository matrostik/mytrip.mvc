         ...
         if (HttpContext.Current.User.IsInRole("blogger"))
         {
             ...
             {%><div class="edit_content">                  
                  <a href="<%=Url.Action("ZU", "C", new { a = Model.Id })%>">
                      <img src="/content/images/edit.png" alt="ïðàâêà" style="border-width: 0px;" /></a> <a href="<%=Url.Action("ZV", "C", new { a = Model.Id })%>"
                          onclick="return confirm ('Âû óâåðåíû ÷òî õîòèòå óäàëèòü òåã?');"><img src="/content/images/delete.png" alt="óäàëèòü" style="border-width: 0px;" /></a>
              </div>   

...
<!-- АДМИН ЧАСТЬ -->
<%if (Model.mt_artycle_category.Blog == true)
  {
...
<a href="<%=Url.Action("ZS", "C", new { a = Model.mt_artycle_category.Id })%>">
            <img src="/content/images/create.png" alt="создать" style="border-width: 0px;" /></a> 
<a href="<%=Url.Action("ZT", "C", new { a = Model.Id })%>"><img src="/content/images/edit.png" alt="правка" style="border-width: 0px;" /></a>
<a href="<%=Url.Action("ZM", "C", new { a = Model.Id })%>" onclick = "return confirm ('Вы уверены что хотите удалить пост?');"><img src="/content/images/delete.png" alt="удалить" style="border-width: 0px;" /></a>     
</div>
...
<%}
  ...
  {
      if (Model.mt_artycle_category.News == false)
      {
          if (HttpContext.Current.User.IsInRole("artycle_editor"))
          {
              if (Model.mt_artycle_category.AddedBy == Page.User.Identity.Name)
              {%><div class="edit_content">
          <a href="<%=Url.Action("ZJ", "C", new { a = Model.mt_artycle_category.Id })%>">
            <img src="/content/images/create.png" alt="создать" style="border-width: 0px;" /></a> 
<a href="<%=Url.Action("ZK", "C", new { a = Model.Id, b=Model.CategoryId})%>"><img src="/content/images/edit.png" alt="правка" style="border-width: 0px;" /></a>
<a href="<%=Url.Action("ZL", "C", new { a = Model.Id })%>" onclick = "return confirm ('Вы уверены что хотите удалить статью?');"><img src="/content/images/delete.png" alt="удалить" style="border-width: 0px;" /></a>     
</div>
<%}
          } if (HttpContext.Current.User.IsInRole("chief_editor"))
          {
...
<%}
      ...
      else
      {
          if (HttpContext.Current.User.IsInRole("artycle_editor"))
          {
              if (Model.mt_artycle_category.AddedBy == Page.User.Identity.Name)
              {%><div class="edit_content">
          <a href="<%=Url.Action("ZW", "C", new { a = Model.mt_artycle_category.Id })%>">
            <img src="/content/images/create.png" alt="создать" style="border-width: 0px;" /></a> 
<a href="<%=Url.Action("ZX", "C", new { a = Model.Id, b=Model.CategoryId})%>"><img src="/content/images/edit.png" alt="правка" style="border-width: 0px;" /></a>
<a href="<%=Url.Action("ZL", "C", new { a = Model.Id })%>" onclick = "return confirm ('Вы уверены что хотите удалить новость?');"><img src="/content/images/delete.png" alt="удалить" style="border-width: 0px;" /></a>     
</div>
<%}
          } if (HttpContext.Current.User.IsInRole("chief_editor"))
          {

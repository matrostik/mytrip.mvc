...
using Mytrip.Mvc.Model.Linq2sql.MoveContent;
...
namespace Mytrip.Mvc.Model.Linq2sql
{
    public class IRepository
    {
        ...
        /*  РАЗДЕЛ 5 MoveContent */
        private MoveContentRepository _MoveContentRepository;
        public MoveContentRepository dm_movecontent
        {
            get
            {
                if (_MoveContentRepository == null)
                    _MoveContentRepository = new MoveContentRepository(_db);
                return _MoveContentRepository;
            }
        }
    }
}

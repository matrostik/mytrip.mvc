...
<small><%= Html.Encode(String.Format("{0:d MMMM yyyy }", x.mt_artycle.AddedDate))%></small><br />
...
<%
    ...
    } %><small><%=Html.Language(Mytrip_Mvc_Language.article_views, x.mt_artycle.Views.ToString())%></small>
<%if (x.mt_artycle.AddComment == true)
  { %><br /><small><%=Html.Language(Mytrip_Mvc_Language.article_comments, x.mt_artycle.mt_artycle_comment.Count().ToString())%></small><%} %>
  <%if (x.mt_artycle.ApprovedVotes == true)
  { %><br /><small><%=Html.Language(Mytrip_Mvc_Language.article_rating, x.mt_artycle.Votes.ToString())%></small><%}

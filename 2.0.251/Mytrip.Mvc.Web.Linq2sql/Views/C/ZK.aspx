...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
  ...
  if (c == "Edit_news") {%><%=Mytrip_Mvc_Language.menu_edit_news%><% }
  if (c == "Edit_article")
  {%><%=Mytrip_Mvc_Language.menu_edit_article%><%}
  if (c == "Edit_post")
  {%><%=Mytrip_Mvc_Language.menu_edit_post%><%}%>
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
<!--/*   Mytrip.Mvc.Web.Linq2sql   Copyright ©  2009 Стюхин Олег Анатольевич   */-->
    <%string c = ViewData["edit"].ToString();
  if (c == "Edit_news") {%><h2><%=Mytrip_Mvc_Language.menu_edit_news%></h2><% }
  if (c == "Edit_article")
  {%><h2><%=Mytrip_Mvc_Language.menu_edit_article%></h2><%}
  if (c == "Edit_post")
  {%><h2><%=Mytrip_Mvc_Language.menu_edit_post%></h2><%}%>
<br />

...
<head runat="server">
    <title><%=ViewData["abstract_model_domain"] %>/<%= Html.Encode(Page.User.Identity.Name) %></title>
    ...
    <table >
        ...
        <tr>
            ...
            <td>  <div class="edit_content">            
                    ...
                    <a href="<%=Url.Action("J", "G", new{a=fd})%>" onclick = "return confirm ('<%=Mytrip_Mvc_Language.delete_folder%>');"><img src="/content/images/delete.png" alt="<%=Mytrip_Mvc_Language.delete%>" style="border-width: 0px;" /></a>   
                </div>
        ...
        <tr>
            ...
            <td>
                ...
                <div class="edit_content">            
                    ...
                    <a href="<%=Url.Action("C", "G", new{a=ef4})%>" onclick = "return confirm ('<%=Mytrip_Mvc_Language.delete_file%>');"><img src="/content/images/delete.png" alt="<%=Mytrip_Mvc_Language.delete%>" style="border-width: 0px;" /></a>   
                </div>

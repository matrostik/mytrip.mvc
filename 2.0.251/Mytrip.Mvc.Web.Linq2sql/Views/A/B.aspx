...
<div style="text-align: center">
    <h2><%= Mytrip_Mvc_Language.licence%></h2>
    <p>
<textarea  cols="20" rows="20" style="width: 600px; height: 400px">
<%= Mytrip_Mvc_Language.GPLv2%>
 </textarea></p></div>
<% using (Html.BeginForm())
   {%>
  
                  <div class="button1">   
    <input type="submit" value="<%= Mytrip_Mvc_Language.agree%>"  class="input_boottom" />
  </div>
    <% } %>
</asp:Content>

...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
	<%= ViewData["abstract_model_domain"]%>/<%= Html.Encode(Model.UserName) %>
</asp:Content>
...
<!--/*   Mytrip.Mvc.Web.Linq2sql   Copyright ©  2009 Стюхин Олег Анатольевич   */-->
    <h2><%= Html.Encode(Model.UserName) %></h2>
        ...
        <p>
         ...
         <p>
            <%=Html.Language(Mytrip_Mvc_Language.last_visit, Model.LastActivityDate.ToString()) %>
        </p> <%if ((bool)ViewData["abstract_model_blog"] == true)
               {%>
        <p>
...
<small><%=Mytrip_Mvc_Language.roles_user%></small>
...
&nbsp;&nbsp;<a href="<%=Url.Action("I", new { a = Model.UserName, b="artycle_editor"})%>">
    <%=Mytrip_Mvc_Language.artycle_editor%></a>&nbsp;&nbsp;
<%} if (admin == "f")
            {
...
&nbsp;&nbsp;<a href="<%=Url.Action("I", new { a = Model.UserName, b="chief_editor"})%>">
    <%=Mytrip_Mvc_Language.chief_editor%></a>&nbsp;&nbsp;
<%}
            }
        } %></div><br /><br /> 
</td>
...
<tr><td style="border-bottom-style: dotted; border-bottom-width: 1px; border-bottom-color: #555152">
<small><%=Mytrip_Mvc_Language.roles_site%></small>

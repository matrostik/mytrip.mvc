...
<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl" %>
  <div class="right_title"> 
    &nbsp;&nbsp;<%=Mytrip_Mvc_Language.menu_search%></div>
    
    <div class="right_content" style="height: 20px;">
<form action="<%=Url.Action("A", "D") %>" method="post">
    <input type="text" name="search" class="search_text1" /><input type="submit" value="" class="search_bottom1"  />
    </form>

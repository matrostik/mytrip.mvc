...
namespace Mytrip.Mvc.Models
{
    ...
    /// <summary>
    /// Модель для страницы /Views/Home/EditAbout.cshtml
    /// </summary>
    [MetadataType(typeof(EditAboutModel))]
    public class EditAboutModel
    {
        /// <summary>
        /// Редактируемый текст About
        /// </summary>
    ...
    public class CoreModel
    {
        ...
        /// <summary>
        /// Уникальные Email пользователей (true - включены)
        /// </summary>
        ...
        /// <summary>
        /// Регистрация (true - разрешена)
        /// </summary>
        public bool unlockRegistration { get; set; }

        /// <summary>
        /// Показ кнопки вход на сайте (true - включен)
        /// </summary>
        ...
        /// <summary>
        /// Выбор тем (true - разрешен)
        /// </summary>
        public bool unlockTheme { get; set; }

        /// <summary>
        /// Gravatar (true - включен)
        /// </summary>
        public bool unlockGravatar { get; set; }

        /// <summary>
        /// Подтверждение пользователя по Email (true - включено)
        /// </summary>
        ...
        /// <summary>
        /// Показ панели управления в сайдбаре (true - включен)
        /// </summary>
        public bool ControlPanelSideBare { get; set; }

        /// <summary>
        /// Показ Donate в сайдбаре (true - включен)
        /// </summary>
        public bool DonateSideBare { get; set; }

        /// <summary>
        /// Вход OpenId (true - разрешен)
        /// </summary>

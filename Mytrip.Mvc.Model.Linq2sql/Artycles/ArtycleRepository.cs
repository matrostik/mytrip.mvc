...
namespace Mytrip.Mvc.Model.Linq2sql.Artycles
{
    public class ArtycleRepository
    {
        ...
        {
            return _db.mt_artycle_in_teg.Where(x => x.TegId == a)
        ...
        {
            return _db.mt_artycle_in_teg.Where(x => x.ArtycleId == a)
        ...
        {
            return _db.mt_artycle.Where(x => x.mt_artycle_category.News == true)
                .Where(x => x.CloseDate >= DateTime.Now)
                .OrderByDescending(x => x.Id);
        }
        /// <summary>

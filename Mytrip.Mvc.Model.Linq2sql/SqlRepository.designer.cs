...
namespace Mytrip.Mvc.Model.Linq2sql
{
	...
	[System.Data.Linq.Mapping.DatabaseAttribute(Name="1gb_mtmvc2beta")]
    ...
    partial void Deletemt_model(mt_model instance);
		...
		public SqlRepositoryDataContext() : 
				base(global::Mytrip.Mvc.Model.Linq2sql.Properties.Settings.Default._1gb_mtmvc2betaConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<mt_artycle_in_teg> mt_artycle_in_teg
		{
			get
			{
		...
		public System.Data.Linq.Table<mt_model> mt_model
		{
			get
			{
	...
	public partial class mt_artycle : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<bool> _DescriptionBody;
		
		private string _Path;
		
		private System.Nullable<bool> _RegistrUser;
		
		private System.Nullable<bool> _ApprovedVotes;
		...
		private EntitySet<mt_artycle_in_teg> _mt_artycle_in_teg;
    ...
    partial void OnDescriptionBodyChanging(System.Nullable<bool> value);
    partial void OnDescriptionBodyChanged();
    partial void OnPathChanging(string value);
    partial void OnPathChanged();
    partial void OnRegistrUserChanging(System.Nullable<bool> value);
    partial void OnRegistrUserChanged();
    partial void OnApprovedVotesChanging(System.Nullable<bool> value);
    ...
    partial void OnEmailChanged();
		...
		public mt_artycle()
		{
			...
			this._mt_artycle_in_teg = new EntitySet<mt_artycle_in_teg>(new Action<mt_artycle_in_teg>(this.attach_mt_artycle_in_teg), new Action<mt_artycle_in_teg>(this.detach_mt_artycle_in_teg));
		...
		[Column(Storage="_Votes", DbType="Int")]
		...
		[Column(Storage="_UrlImageDescription", DbType="NVarChar(256)")]
		...
		[Column(Storage="_UrlImageBody", DbType="NVarChar(256)")]
		...
		[Column(Storage="_DescriptionBody", DbType="Bit")]
		public System.Nullable<bool> DescriptionBody
		{
			get
			{
		...
		[Column(Storage="_RegistrUser", DbType="Bit")]
		public System.Nullable<bool> RegistrUser
		{
			get
			{
		...
		[Column(Storage="_ApprovedVotes", DbType="Bit")]
		public System.Nullable<bool> ApprovedVotes
		{
			get
			{
		...
		[Column(Storage="_CloseDate", DbType="DateTime")]
		...
		[Association(Name="mt_artycle_mt_artycle_in_teg", Storage="_mt_artycle_in_teg", ThisKey="Id", OtherKey="ArtycleId")]
		public EntitySet<mt_artycle_in_teg> mt_artycle_in_teg
		{
			get
			{
				return this._mt_artycle_in_teg;
			}
			set
			{
				this._mt_artycle_in_teg.Assign(value);
			}
		}
		...
		private void attach_mt_artycle_in_teg(mt_artycle_in_teg entity)
		{
			this.SendPropertyChanging();
			entity.mt_artycle = this;
		}
		
		private void detach_mt_artycle_in_teg(mt_artycle_in_teg entity)
		{
			this.SendPropertyChanging();
			entity.mt_artycle = null;
		}
	...
	public partial class mt_artycle_category : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<bool> _Blog;
    ...
    partial void OnBlogChanging(System.Nullable<bool> value);
    ...
    partial void OnCategoryIdChanged();
		...
		[Column(Storage="_Blog", DbType="Bit")]
		public System.Nullable<bool> Blog
		{
			get
			{
				return this._Blog;
		...
		[Column(Storage="_News", DbType="Bit")]
		...
		public mt_artycle mt_artycle
		{
			...
			set
			{
							...
							|| (this._mt_artycle.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._mt_artycle.Entity = null;
						previousValue.mt_artycle_in_teg.Remove(this);
					}
					this._mt_artycle.Entity = value;
					if ((value != null))
					{
						value.mt_artycle_in_teg.Add(this);
						this._ArtycleId = value.Id;
					}
					else
					{
    ...
    partial void OnPathChanged();
		...
		[Association(Name="mt_artycle_teg_mt_artycle_in_teg", Storage="_mt_artycle_in_teg", ThisKey="Id", OtherKey="TegId")]
		public EntitySet<mt_artycle_in_teg> mt_artycle_in_teg
		{
			get
			{

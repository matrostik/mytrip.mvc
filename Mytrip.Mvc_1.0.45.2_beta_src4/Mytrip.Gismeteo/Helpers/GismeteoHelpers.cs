...
namespace Mytrip.Gismeteo.Helpers
{
   public static class GismeteoHelpers
   {
       ...
       static string EditDelete(int rssId)
       {
           ...
           imgEdit.MergeAttribute("title", GismeteoLanguage.edit);
           ...
           imgDelete.MergeAttribute("title", GismeteoLanguage.delete);
           ...
           DeleteCategory.MergeAttribute("onclick", "return confirm ('" + GismeteoLanguage.are_you_sure + "');");

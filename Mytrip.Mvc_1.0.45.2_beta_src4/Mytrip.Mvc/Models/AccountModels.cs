   ...
   /// </summary>
    ...
    public class EmailRegisterAttribute : ValidationAttribute
    {
        ...
        public override bool IsValid(object value)
        {
            ...
            bool result = true;
            if (!String.IsNullOrEmpty(email) && userset.requiresUniqueEmail() && !db.mtAccessibleEmail(email))
            {
                result = false;
            }
            return result;
    ...
    public class MinPasswordAttribute : ValidationAttribute
    {
        ...
        public override bool IsValid(object value)
        {
            ...
            bool result = true;
            if (!String.IsNullOrEmpty(password) && userset.minRequiredPasswordLength() > password.Length)
            {
                result = false;
            }
            return result;
        ...
        public override string FormatErrorMessage(string name)
        {
            return String.Format(CultureInfo.CurrentCulture,
              ErrorMessageString, userset.minRequiredPasswordLength());
        }
    ...
    public class CaptchaNullStringAttribute : ValidationAttribute
    {
        ...
        public override bool IsValid(object value)
        {
            ...
            bool result = true;
            if (!core.Development() && userset.unlockCaptcha() && String.IsNullOrEmpty(captcha))
            {
                result = false;
            }
    ...
    public class CaptchaErrorAttribute : ValidationAttribute
    {
        ...
        public override bool IsValid(object value)
        {
            var captcha = (String)value;
            bool result = true;
            if (!core.Development() && userset.unlockCaptcha() && db.mtHashCaptcha(captcha) != HttpContext.Current.Session["antibotimage"].ToString())
            {
                result = false;
            }

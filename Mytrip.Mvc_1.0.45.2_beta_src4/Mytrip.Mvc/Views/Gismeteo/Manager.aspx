...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
	<%=Html.PageTitle(GismeteoLanguage.Gismeteo_manager, "/")%>
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">

    <h2 class="title"><%=GismeteoLanguage.Gismeteo_manager%></h2>
    ...
    <div class="acfooter"></div>
     ...
     <h2 class="title"><%=GismeteoLanguage.add_Gismeteo%></h2>
    <div><div class="contenttopright"></div><div class="contenttopleft"></div><div class="contenttopcon"></div></div><div class="content2">
                ...
                <%=Html.MytripInput("submit", GismeteoLanguage.add_Gismeteo)%>
                <% } %>

...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
	 <%=Html.PageTitle(CoreLanguage.topmenu_setting, "/")%>
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
<h2 class="title">
<%=CoreLanguage.topmenu_setting%></h2>
<div><div class="contenttopright"></div><div class="contenttopleft"></div><div class="contenttopcon"></div></div><div class="content2">              
* <%=CoreLanguage.topmenu_setting%>. <%=CoreLanguage.menu_setting_desc %>
                ...
                <div id="<%=newitem.Index %>">
                 <div><div class="contenttopright"></div><div class="contenttopleft"></div><div class="contenttopcon"></div></div><div class="content2">
                   ...
                   <td> 
                    ...
                    <img src="/Theme/<%=Model.Theme %>/images/uparrow_blue.png" alt="<%=CoreLanguage.up %>" 
                    title="<%=CoreLanguage.up %>" height="16px" /></a> <a href="#" id="down<%=newitem.Index %>">
                        <img src="/Theme/<%=Model.Theme %>/images/downarrow_blue.png" alt="<%=CoreLanguage.down %>" title="<%=CoreLanguage.down %>" 
                        height="16px" /></a>
                    </span>
                     </td>
                     </tr>

...
namespace Mytrip.Mvc.Repository
{
    ...
    public class CaptchaRepository
    {
        ...
        public Bitmap mtGenerateImage(int ImageWidth, int ImageHeight, string fontFamily, out string _solution)
        {
        ...
        private string mtGenerateRandomString(int size)
        {
        ...
        private string mtHashCaptcha(string captcha)
        {
            string c = FormsAuthentication
                .HashPasswordForStoringInConfigFile((userset.applicationName() + captcha), "SHA1");
            return c;
        }
    }
}

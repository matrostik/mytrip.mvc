...
namespace Mytrip.Core.Helpers
{
    ...
    public static class PagerHelper
    {
        ...
        public static string MytripPager(this HtmlHelper html, int defaultPageSize, int total, string staticText, string cssClass, string cssClassActiv, string cssClassStatic)
        {
            ...
            table_td_pager.MergeAttribute("style", "text-align: left;border:0;");
            ...
            table_td_count.MergeAttribute("style", "text-align: right;border:0;");
            ...
            table.MergeAttribute("style", "width: 100%;border:0;");

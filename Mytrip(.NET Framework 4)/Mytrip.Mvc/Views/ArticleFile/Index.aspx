<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/PopUp.Master" Inherits="System.Web.Mvc.ViewPage<Mytrip.Core.Models.IndexFilesModels>" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
 <div style="position: relative; float: right; width: 450px; text-align: right;">
        <% Html.EnableClientValidation(); %>
            ...
            <% } %>
            <% using (Html.BeginForm("AddFile", "ArticleFile", new { directory = Model.Directory,param=Model.Param}, FormMethod.Post,
    ...
    <table>
        <tr>
            ...
            <th>
                <%= Html.MytripDirectory(Model.Directory, "ArticleFile",Model.Param)%>
            </th>
        </tr>
    </table>
    ...
    <table>
        ...
        <tr>
            <td>
                <%=Html.MytripImageLink(Url.Action("Rename", "ArticleFile", new { directory,param=Model.Param, param2 = "folder" }),
                                                                     "/Content/images/rename.png", CoreLanguage.rename, 20, 0, 0)%>
                <%=Html.MytripImageLink(Url.Action("Delete", "ArticleFile", new { directory, param = Model.Param, param2 = "folder" }),
                                                                     "/Content/images/delete.png", "delete", 20, 0, 0, CoreLanguage.are_you_sure)%>
            </td>
            <td>
                <%=Html.MytripImageLink(Url.Action("Index", "ArticleFile", new { directory, param = Model.Param }),
                                            "/Content/files/Stuffed_Folder.png", x.Name, 0, 32, 0)%>
            </td>
            <td>
                <%=Html.MytripActionLink(Url.Action("Index", "ArticleFile", new { directory, param = Model.Param }), x.Name)%>
            </td>
            <td>
            </td>
            <td>
        ...
        <tr>
            <td>
             <%=Html.MytripAddTextArea(id,directory.Replace("()", "/"),x.Name,x.Extension)%>
                <%id++; %>
                <%=Html.MytripImageLink(Url.Action("Rename", "ArticleFile", new { directory, param = Model.Param, param2 = "file" }),
                                                                     "/Content/images/rename.png", CoreLanguage.rename, 20, 0, 0)%>
                <%=Html.MytripImageLink(Url.Action("Delete", "ArticleFile", new { directory, param = Model.Param, param2 = "file" }),
                                                                     "/Content/images/delete.png", "delete", 20, 0, 0, CoreLanguage.are_you_sure)%>
            </td>
            <td>

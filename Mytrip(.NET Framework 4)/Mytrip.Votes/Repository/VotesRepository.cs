...
namespace Mytrip.Votes.Repository
{
    public class VotesRepository
    {
        ...
        public void CreateQuestion(string question,bool active,bool allCulture,string culture,DateTime closeDate)
        {
            mytrip_VotesQuestion x = new mytrip_VotesQuestion
            {
                ...
                Culture=culture,
                TotalVotes=0,
                Path= StaticMethod.DecodingString(question),
                CreateDate=DateTime.Now,
                CloseDate=closeDate
            };
            entities.AddTomytrip_VotesQuestion(x);

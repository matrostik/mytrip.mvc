...
namespace Mytrip.Mvc.Helpers
{
    ...
    public static class PagerHelper
    {
        ...
        {          
            ...
            {
                result.AppendLine(GeneralMethods.Button(Controller + "1" + sort, "1", false, "left")); 
            }
            ...
            if (pageIndex <= 4)
            {
                for (_page_Index = _pageIndex; pageTotal >= _page_Index; _page_Index++)
                {
                    ...
                    {
                        result.AppendLine(GeneralMethods.Button(Controller + _page_Index + sort, _page_Index.ToString(), false, "left")); 
                    }
                    if (_page_Index == pageTotal - 1)
                        break;
                    else if (_page_Index == pageIndex + 3)
                        break;
            ...
            if (pageTotal >= 3)
            {
                ...
                {
                    result.AppendLine(GeneralMethods.Button(Controller + pageTotal + sort, pageTotal.ToString(), false, "left"));
                }
            }
        ...
        private static string PagerCount(int defaultPageSize, int total)
        {
            ...
            if (total > 50)
            {
                if (pageSize == 100)
                {
                    result.AppendLine(GeneralMethods.Button(string.Empty, "100", true, "right"));
                }
                else
                {
                    result.AppendLine(GeneralMethods.Button(Controller + "1/100" + sort, "100", false, "right"));
                }
            }
            if (total > 25)
            {
                if (pageSize == 50)
                {
                    result.AppendLine(GeneralMethods.Button(string.Empty, "50", true, "right"));
                }
                else
                {
                    result.AppendLine(GeneralMethods.Button(Controller + "1/50" + sort, "50", false, "right"));
                }
            }
            if (total > 10)
            {
                if (pageSize == 25)
                {
                    result.AppendLine(GeneralMethods.Button(string.Empty, "25", true, "right"));
                }
                else
                {
                    result.AppendLine(GeneralMethods.Button(Controller + "1/25" + sort, "25", false, "right"));
                }
            }
            if (pageSize == 10)
            {
                result.AppendLine(GeneralMethods.Button(string.Empty, "10", true, "right"));
            }
            else
            {
                result.AppendLine(GeneralMethods.Button(Controller + "1/10" + sort, "10", false, "right"));
            }
            if (pageSize == 5)
            {
                result.AppendLine(GeneralMethods.Button(string.Empty, "5", true, "right"));
            }
            else
            {
                result.AppendLine(GeneralMethods.Button(Controller + "1/5" + sort, "5", false, "right"));
            }

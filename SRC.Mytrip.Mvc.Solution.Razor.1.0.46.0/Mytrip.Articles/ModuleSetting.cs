...
namespace Mytrip.Articles
{
    public static class ModuleSetting
    {
        ...
        static string moduleVersion = "1.0.46.0";
        ...
        {
            return int.Parse(GeneralMethods.MytripCache("as_cacheseconds", moduleName, "cacheSeconds", false, null, 36000, CacheItemPriority.High).ToString());
        }
        //****************** E N D **********************
        #endregion

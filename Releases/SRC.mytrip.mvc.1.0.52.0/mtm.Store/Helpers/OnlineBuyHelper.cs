    ...
    public static class OnlineBuyHelper
    {
        public static HtmlString OnlineBuy(this HtmlHelper html)
        {
            ...
            if (ModuleSetting.paypal())
            {
                ...
                result.Append("<input type=\"hidden\" name=\"cancel_return\" value=\"http://" +CoreSetting.applicationName()+ "/Store/Cart\">");
                result.Append("<input type=\"hidden\" name=\"return\" value=\"http://" + CoreSetting.applicationName() + "/Store/OnlineBuy\">");

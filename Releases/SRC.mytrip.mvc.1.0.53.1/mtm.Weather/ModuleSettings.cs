...
namespace mtm.Weather
{
   ...
   {  
       ...
       public static string NameWeatherPage(string culture)
       {
           return GeneralMethods.MytripCache("gm_nameWeather", InstallAndUninstall.moduleName, "nameWeather", true,culture, null, 36000, CacheItemPriority.High).ToString();
       }
       ...
       {
           return GeneralMethods.MytripCache("gm_partialaccordion", InstallAndUninstall.moduleName, "partialAccordion", false, null, 36000, CacheItemPriority.High).ToString();
       }
       public static string partialNoAccordion()
       {
           return GeneralMethods.MytripCache("gm_partialnoaccordion", InstallAndUninstall.moduleName, "partialNoAccordion", false, null, 36000, CacheItemPriority.High).ToString();
       }
       //****************** E N D **********************
       #endregion

...
namespace mtm.Core.Settings
{
    ...
    public static class CoreSetting
    {
        ...
        public static string NameTitlePage(string culture)
        {
            return GeneralMethods.MytripCache("mtm_cs_nametitlepage", "core", "nameTitle", true,culture, null, 36000, CacheItemPriority.High).ToString();
        }

        public static string nameLogo(string culture)
        {
            return GeneralMethods.MytripCache("mtm_cs_namelogo", "core", "nameLogo", true,culture, null, 36000, CacheItemPriority.High).ToString();
        }
        ...
        /// </summary>
        /// <returns>возвращает string</returns>
        public static string NameHomePage()
        {
            return GeneralMethods.MytripCache("mtm_cs_namehomepage", "core", "nameHome", true,  null, 36000, CacheItemPriority.High).ToString();
        }
        public static string NameHomePage(string culture)
        {
            return GeneralMethods.MytripCache("mtm_cs_namehomepage", "core", "nameHome", true,culture, null, 36000, CacheItemPriority.High).ToString();
        }
        public static string HomePageKeyWords()
        {
            return GeneralMethods.MytripCache("mtm_cs_homepagekeywords", "core", "nameHome", "keywords", null, 36000, CacheItemPriority.High).ToString();
        }
        public static string HomePageTitle()
        {
            return GeneralMethods.MytripCache("mtm_cs_homepagetitle", "core", "nameHome", "title", null, 36000, CacheItemPriority.High).ToString();
        }
        public static string HomePageDesc()
        {
            return GeneralMethods.MytripCache("mtm_cs_homepagedescription", "core", "nameHome", "description", null, 36000, CacheItemPriority.High).ToString();
        }
        public static string HomePageKeyWords(string culture)
        {
            return GeneralMethods.MytripCache("mtm_cs_homepagekeywords", "core", "nameHome", "keywords", culture, null, 36000, CacheItemPriority.High).ToString();
        }
        public static string HomePageTitle(string culture)
        {
            return GeneralMethods.MytripCache("mtm_cs_homepagetitle", "core", "nameHome", "title", culture, null, 36000, CacheItemPriority.High).ToString();
        }
        public static string HomePageDesc(string culture)
        {
            return GeneralMethods.MytripCache("mtm_cs_homepagedescription", "core", "nameHome", "description", culture, null, 36000, CacheItemPriority.High).ToString();
        }

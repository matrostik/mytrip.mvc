...
namespace mtm.Core.Helpers
{
    public static class StatisticHelper
    {
        ...
        public static HtmlString Statistic(this HtmlHelper html, IQueryable<mytrip_corestatistic> body)
        {
            StringBuilder result = new StringBuilder();
            string ipusers = "";
            string browser = "";
            ...
            _a += "<div class='scroll'><table class='noborders'>";
            foreach (var _dic in dic.OrderByDescending(x => x.Value))
            {
                decimal br = (_dic.Value * 100 )/ countbrow;
                _a +="<tr><td>"
            ...
            _a += "</table></div>";
            _a += "</td></tr></table>";
            result.AppendLine(GeneralMethods.Accordion(html,CoreLanguage.infoUsers, _a));
            #endregion

            result.AppendLine(GeneralMethods.Accordion(html, CoreLanguage.infoPages, _a1));
        ...
        public static HtmlString StatisticMap(this HtmlHelper html)
        {
            if (GeoSetting.unlockGeo())
            {
                ...
                return new HtmlString(GeneralMethods.Accordion(html, CoreLanguage.statisticMap, a));
            }
            else return null;
        }

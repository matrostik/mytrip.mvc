...
namespace mtm.Core.Repository
{
    ...
    internal class InstallModuleRepository
    {
        ...
        internal void CreateProfileSmall()
        {
            ...
            EditePageRepository.CreatePage("/Views/Shared/Partial/_profileSmall.cshtml", result.ToString());
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        internal void CreateProfile(string culture)
        {
            ...
            StringBuilder result = new StringBuilder();
            string[] sidebar = EditePageRepository.WritePage("/Views/Home/Partial/_profileBig.cshtml");
            ...
            result.AppendLine("})");
            EditePageRepository.CreatePage("/Views/Home/Partial/_profileBig.cshtml", result.ToString());
        }
        internal void CreateRss()
        {
            ...
            EditePageRepository.CreatePage("/Views/Shared/Partial/_rss.cshtml", result.ToString());
        }
        /// <summary>
        /// 
        /// </summary>
        internal void CreateSideBarProfile()
        {
            ...
            EditePageRepository.CreatePage("/Views/Shared/Partial/_sideBarProfile.cshtml", result.ToString());
        }
        ...
        internal void CreateMenu(string culture)
        {
            ...
            StringBuilder result = new StringBuilder();
            string[] sidebar = EditePageRepository.WritePage("/Views/Shared/Partial/_menu.cshtml");
            ...
            result.AppendLine("})");
            EditePageRepository.CreatePage("/Views/Shared/Partial/_menu.cshtml", result.ToString());
        }
        internal void CreateSiteMap(string culture)
        {
            string export = string.Empty;
            string _export = string.Empty;
            int count = 0;
            ...
            StringBuilder result = new StringBuilder();
            string[] sidebar = EditePageRepository.WritePage("/Views/Shared/Partial/_sitemap.cshtml");
            result.AppendLine("@inherits System.Web.Mvc.WebViewPage");
            result.AppendLine("@{");
            result.AppendLine("/* WARNING AUTO GENERATE CODE */");
            result.AppendLine(" ");
            ...
            result.AppendLine("@Html.MytripSiteMap(new {");
            result.AppendLine("/*--StartSiteMap--*/");
            bool end = false;
            foreach (string x in sidebar)
            {
                if (x.IndexOf("/*--EndSiteMap--*/") != -1)
                    end = false;
                if (end && x.Contains("="))
                {
                    string _x = x.Remove(0, x.IndexOf("=") + 1);
                ...
                else if (x.IndexOf("/*--StartSiteMap--*/") != -1)
                    end = true;
            }
            _export += export;
            string[] _result = _export.Split('|');
            ...
            count = result.Length;
            result = result.Remove(count - 3, 1);
            result.AppendLine("/*--EndSiteMap--*/");
            result.AppendLine("})");
            result.AppendLine("</ul>");
            EditePageRepository.CreatePage("/Views/Shared/Partial/_sitemap.cshtml", result.ToString());
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        internal IDictionary<string, string> SideBarPage(string culture)
        {
            ...
            foreach (var x in alldllMassive())
            {
                ...
                if (parser != null && parser != "")
                {
                    ...
                    {
                        string[] _q = q.Split('_');
                        string _name = _name = string.Concat("Html.", _q[0], "()");
                        string _name2 = _q[1];
                        result.Add(_name, _name2);
                    }
                }
        ...
        {
            IDictionary<string, string> result = new Dictionary<string, string>();
            string[] sidebar = EditePageRepository.WritePage("/Views/Shared/Partial/_profileSmall.cshtml");
            int count = 1;
            int StartProfile = 0;
            int EndProfile = 0;
            foreach (string x in sidebar)
        ...
        {
            IDictionary<string, string> result = new Dictionary<string, string>();
            string[] sidebar = EditePageRepository.WritePage("/Views/Shared/Partial/_sideBarProfile.cshtml");
            int count = 1;
            int StartProfile = 0;
            int EndProfile = 0;
            foreach (string x in sidebar)

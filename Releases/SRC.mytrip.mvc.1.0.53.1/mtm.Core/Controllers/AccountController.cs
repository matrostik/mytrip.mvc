...
namespace mtm.Core.Controllers
{
    ...
    public class AccountController : ICoreController
    {
        ...
        public ActionResult LogOn(string returnUrl, string error)
        {
            ...
            model.LabelUserName = (UsersSetting.EmailasUsername()) ? CoreLanguage.Email : CoreLanguage.UserName;
            ...
            model.errorOpenId =error==null?null: "<div class='noappr'>" + error + "</div>";
        ...
        public ActionResult LogOn(LogOnModel model, string returnUrl)
        {
            if (UsersSetting.unlockSiteId() && ModelState.IsValid & ValidateLogon(model.UserName, model.Password))
            {
                ...
                GeneralMethods.MytripCacheRemoveContains("mtm_getlatestusers");
                coreRepo.membershipRepo.CityIdProfile(model.UserName);
        ...
        public ActionResult Register(string returnUrl)
        {
            ...
            {
                coreRepo.geoRepo.CreateCityZero();
                ...
                string[] a = { "<a href='/Account/LogOn?returnUrl=" + returnUrl + "'>" + CoreLanguage.logon + "</a>", CoreLanguage.register };
                model.bread=a;
                return View(model);
            }
            else
            ...
            if (UsersSetting.unlockSiteId() && UsersSetting.unlockRegistration() && (ModelState.IsValid & ValidateConfirmPassword(model.Password, model.ConfirmPassword, "Password")))
            {
                ...
                if (createStatus == MembershipCreateStatus.Success)
                {
                    ...
                    if (!CoreSetting.Development() && EmailSetting.unlockSendEmail() && UsersSetting.unlockApprovedEmail())
                    {
                        ...
                        string linksite = "<a href='http://" + CoreSetting.applicationName() + "'>" + CoreSetting.applicationName() + "</a>";
                        string appremail = "<a href='http://" + CoreSetting.applicationName() + "/Account/ApprovedAccount?_id=" + userId + "&returnUrl=" + returnUrl + "'>" + CoreSetting.applicationName() + "/Account/ApprovedAccount</a>";
                        string subject = string.Format(CoreLanguage.subjectEmail, CoreSetting.applicationName());
                    ...
                    {if(UsersSetting.EmailasUsername())
                        coreRepo.formsService.SignIn(model.Email, false);
                    else
        ...
        public ActionResult ChangePassword()
        {
            ...
            string[] a = { "<a href='/Home/Profile/" + User.Identity.Name + "'>" + CoreLanguage.my_profile + "</a>", CoreLanguage.change_password };
            model.bread = a;
            return View(model);
        }
        ...
        public ActionResult ChangeEmail()
        {
            ...
            TempData["username"] = User.Identity.Name;
            string[] a = { "<a href='/Home/Profile/" + User.Identity.Name + "'>" + CoreLanguage.my_profile + "</a>", CoreLanguage.change_email };
            model.bread = a;
            return View(model);
        }
        /// <summary>POST: /Account/ChangePassword
        ...
        public ActionResult ForgotPassword(bool _id, string returnUrl)
        {
            ...
            string[] a = { "<a href='/Account/LogOn?returnUrl=" + returnUrl + "'>" + CoreLanguage.logon + "</a>", CoreLanguage.forgotPassword };
            model.bread = a;
            return View(model);
        }
        [HttpPost]
            ...
            if (ModelState.IsValid)
            {
                ...
                foreach (var _x in x)
                {
                    ...
                    else
                    {
                        ...
                        string linksite = "<a href='http://" + CoreSetting.applicationName() + "'>" + CoreSetting.applicationName() + "</a>";
                        string appremail = "<a href='http://" + CoreSetting.applicationName() + "/Account/RecoveryPassword?_id=" + userId + "&returnUrl=" + returnUrl + "'>" + CoreSetting.applicationName() + "/Account/RecoveryPassword</a>";

                        string subject = string.Format(CoreLanguage.recovryPassword,CoreSetting.applicationName());
        ...
        public ActionResult OpenIdLogin(string openid, string returnUrl)
        {
            ...
            {
                string[] _op = returnUrl.Split('|');
                openid = string.Format(openid, _op[1]);
                returnUrl = _op[0];
            }
        ...
        public ActionResult OpenIdRegister(string id, string id2, string returnUrl)
        {
            ...
            string[] a = { "<a href='/Account/LogOn?returnUrl=" + returnUrl + "'>" + CoreLanguage.logon + "</a>", CoreLanguage.UserNameforsite };
            model.bread = a;
            return View(model);
        }

...
namespace mtm.Votes
{
   public static class Export
   {
       ...
       public static HtmlString mtmVotesExportAccordionVotes(this HtmlHelper html)
       {
           if (ModuleSetting.unlockVotes())
           {
                   ...
                   || HttpContext.Current.Request.Cookies["mtVotes" + q.QuestionId].Value != "votes" + q.CreateDate.ToLongTimeString()))
               {
                   ...
                   return new HtmlString(GeneralMethods.Accordion(
                    ...
                    html, ModuleSetting.NameVotesPage(), form.ToString()));
               }
               else if (q != null)
               {
                   ...
                   return new HtmlString(GeneralMethods.Accordion(
                    ModuleSetting.partialAccordion(),
                    html, ModuleSetting.NameVotesPage(), VotesHelpers.BuildResult(q)));
               }
               else return null;
           }
           else

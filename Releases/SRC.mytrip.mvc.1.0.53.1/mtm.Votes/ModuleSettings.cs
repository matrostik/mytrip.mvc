...
namespace mtm.Votes
{
    public static class ModuleSetting
    {
       #region Данные из mtm.Config.xml
        ...
        public static string NameVotesPage(string culture)
        {
            return GeneralMethods.MytripCache("vs_namevotes", InstallAndUninstall.moduleName, "nameVotes", true, culture, null, 36000, CacheItemPriority.High).ToString();
        }
        /// <summary>
        ...
        {
            return GeneralMethods.MytripCache("vs_partialaccordion", InstallAndUninstall.moduleName, "partialAccordion", false, null, 36000, CacheItemPriority.High).ToString();
        }
        public static string partialNoAccordion()
        {
            return GeneralMethods.MytripCache("vs_partialnoaccordion", InstallAndUninstall.moduleName, "partialNoAccordion", false, null, 36000, CacheItemPriority.High).ToString();
        }
        //****************** E N D **********************
        #endregion

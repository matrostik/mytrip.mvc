            ...
            if (filename.Contains(".xls"))
            {
                ...
                foreach (var x in producer)
                {
                    try
                    {
                        ...
                        {
                            store.producer.CreateProducer((int)x.ProducerId, x.Title, body, allculture, culture, saleid,null,null,null,null);
                        }
                    }
                    catch { }
                }
            ...
            if (filename.Contains(".xls"))
            {
                ...
                foreach (var x in producer.Where(z => z.SubDepartmentId == null || z.SubDepartmentId == "null"))
                {
                    try
                    {
                        ...
                        {
                            store.department.CreateDepartment((int)x.DepartmentId, 0, x.Title, body, allculture, culture, saleid,null,null,null,null);
                        }
                ...
                foreach (var x in producer.Where(z => z.SubDepartmentId != null && z.SubDepartmentId != "null"))
                {
                    try
                    {
                        ...
                        {
                            store.department.CreateDepartment((int)x.DepartmentId, departmentid, x.Title, body, allculture, culture, saleid,null,null,null,null);
                        }
                    }
                    catch { }
                }
            ...
            if (filename.Contains(".xls"))
            {
                ...
                foreach (var x in producer)
                {
                    try
                    {
                        ...
                        {
                            store.product.CreateProduct(id,departmentid,producerid, x.Title, body,details,x.Culture, allculture,(decimal)x.Price,(int)x.TotalCount,null,viewcount,viewprice,viewvotes,packing,x.MoneyId,nambercatalog, saleid,null,null,null,null);
                        }
                    }
                    catch { }
                }

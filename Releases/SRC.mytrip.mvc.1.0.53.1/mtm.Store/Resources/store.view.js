$(document).ready(function () {
    ...
    Rating();
    $("input.comparision").click(function () {//.live('click', function () {
    ...
    $('span#zoomimg').click(function () {
        //alert('zoom');
        //$("div.windo#zoom").show();
        var a = $(this).find("img").attr('src');
        $("div.window#zoom").find("img").attr('src', a);
        var id = 'div.window#zoom';
        //$(id).css({ width: (326 + 'px') });
        var maskHeight = $(document).height();
        var maskWidth = $(window).width();
        $('div.mask').css({ 'width': maskWidth, 'height': maskHeight });
    ...
    //    $("span#zoomimg").live('click', function () {
    //        $('div.tabI').each(function () {
    //            $(this).find("div.tabR, div.tabL, div.tabC").removeClass("ac");
    //        });
    //        var a = $(this).parent("div.tabC");

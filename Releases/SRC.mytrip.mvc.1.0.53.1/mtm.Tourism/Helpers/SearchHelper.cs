   ...
   public static class SearchHelpers
   {
       public static List<SearchQuestion> Search(string search)
       {
           ...
           foreach (var x in a)
           {
               ...
               {
                   _content.Append(ToursLanguage.category + ": <a href='/Tours/Index/1/10/" + x.CategoryId + "/0/" + x.mytrip_tourscategory.Path + "'>" + x.mytrip_tourscategory.Title + "</a><br/>");
               }
               else if (x.mytrip_tourscategory.SubCategoryId > 0)
               {
                   _content.Append(ToursLanguage.category + ": <a href='/Tours/Index/1/10/" + x.mytrip_tourscategory.SubCategoryId + "/0/" + x.mytrip_tourscategory.mytrip_tourscategory2.Path + "'>" + x.mytrip_tourscategory.mytrip_tourscategory2.Title + "</a><br/>");
                   _content.Append(ToursLanguage.subcategory + ": <a href='/Tours/Index/1/10/" + x.CategoryId + "/0/" + x.mytrip_tourscategory.Path + "'>" + x.mytrip_tourscategory.Title + "</a><br/>");
               }

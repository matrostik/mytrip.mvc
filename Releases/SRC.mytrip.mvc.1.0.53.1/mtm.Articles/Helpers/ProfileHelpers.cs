...
namespace mtm.Articles.Helpers
{
    public static class ProfileHelpers
    {
        ...
        public static List<LastActivity> GetLastActivities(string username, string path)
        {
            ...
            return la.OrderBy(x => x.Date).ToList();
        }
        /// <summary>
        /// ActivityText
        /// </summary>
        ...
        static string ActivityText(object obj)
        {
            ...
            if (obj is mytrip_articlescategory)
            {
                ...
                if (category.SubCategoryId != 0)
                {
                    ...
                    // tooltip
                    clink.MergeAttribute("rel", "Category," + category.mytrip_articlescategory2.CategoryId);
        ...
        static HtmlString AwaitingModeration(string username)
        {
            ...
            foreach (var c in ar.comment.GetComments(username))
            {
                ...
                // tooltip
                article.MergeAttribute("rel", "Article," + c.ArticleId);
                article.AddCssClass("mtPopupArticles");
                //
                ...
                // tooltip
                cat.MergeAttribute("rel", "Category," + c.mytrip_articles.CategoryId);
                cat.AddCssClass("mtPopupArticles");
                //
                if (c.mytrip_articles.mytrip_articlescategory.Blog)
                {
                    ...
                    else
                    {
                        ...
                        // tooltip
                        cat1.MergeAttribute("rel", "Category," + c.mytrip_articles.mytrip_articlescategory.SubCategoryId);
                        cat1.AddCssClass("mtPopupArticles");
                        //
        ...
        public static HtmlString Subscriptions(this HtmlHelper html, string username)
        {
            ...
            th3.MergeAttribute("style", "width:55px;text-align:center;");
            th3.InnerHtml = ArticleLanguage.comments;
            TagBuilder th4 = new TagBuilder("td");
            th4.MergeAttribute("style", "width:85px;text-align:center;");
            ...
            foreach (var subs in ar.subscription.GetSubsciptions(username))
            {
                ...
                TagBuilder td1 = new TagBuilder("td");
                td1.MergeAttribute("style", "width:30px;text-align:center;");
                ...
                // tooltip
                a.MergeAttribute("rel", "Article," + subs.ArticleId);
                a.AddCssClass("mtPopupArticles");
                //
                TagBuilder d1 = new TagBuilder("div");
                ...
                if (subs.mytrip_articles.mytrip_articlescategory.SubCategoryId == 0)
                {
                    ...
                    a1.InnerHtml = subs.mytrip_articles.mytrip_articlescategory.Title;
                    a1.MergeAttribute("href", "/Article/Index/1/10/" + subs.mytrip_articles.CategoryId + "/" + subs.mytrip_articles.mytrip_articlescategory.Path);
                    // tooltip
                    a1.MergeAttribute("rel", "Category," + subs.mytrip_articles.CategoryId);
                    a1.AddCssClass("mtPopupArticles");
                    //
                    d4.InnerHtml = "<b>" + ArticleLanguage.category + "</b>: " + a1;
                }
                else
                {
                    TagBuilder a1 = new TagBuilder("a");
                    ...
                    a2.InnerHtml = subs.mytrip_articles.mytrip_articlescategory.mytrip_articlescategory2.Title;
                    a2.MergeAttribute("href", "/Article/Index/1/10/" + subs.mytrip_articles.mytrip_articlescategory.SubCategoryId + "/" + subs.mytrip_articles.mytrip_articlescategory.mytrip_articlescategory2.Path);
                    // tooltip
                    a2.MergeAttribute("rel", "Category," + subs.mytrip_articles.mytrip_articlescategory.SubCategoryId);
                    a2.AddCssClass("mtPopupArticles");
                    //
                    d4.InnerHtml = "<b>" + ArticleLanguage.subcategory + "</b>: "+a1 + " | <b>" + ArticleLanguage.category + "</b>: "+a2;
                }

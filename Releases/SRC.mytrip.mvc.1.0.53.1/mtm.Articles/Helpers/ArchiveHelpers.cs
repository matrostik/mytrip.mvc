    ...
    public static class ArchiveHelpers
    {
        ...
        static string EditDelete(object obj)
        {
            if (obj is mytrip_articlescategory)
            {
                ...
                rel += "_" + category.Path + "_" + category.SeoTitle + "_" + category.SeoKeyword + "_" + category.SeoDescription;
                return GeneralMethods.ImageLink("modalCategory_" + category.CategoryId, "#"
            ...
            else if (obj is mytrip_articlestag)
            {
                ...
                string rel = tag.TagId + "_false_false_false_false_(Tag)";
                return GeneralMethods.ImageLink("modalCategory_" + tag.TagId, "" + tag.Path, ArticleLanguage.edit, tag.TagName,

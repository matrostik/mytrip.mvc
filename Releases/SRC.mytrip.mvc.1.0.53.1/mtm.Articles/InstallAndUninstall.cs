...
namespace mtm.Articles
{
    public static class InstallAndUninstall
    {
        ...
        public static void CreateAllFiles()
        {
            ...
            EditePageRepository.CreatePage("/Views/Article/Seo.cshtml", WebPages.Seo);
            EditePageRepository.CreatePage("/Views/Article/Web.config", WebPages.Web);
            absolutDirectory = HttpContext.Current.Server.MapPath("/Views/Article/Partial");
            _absolutDirectory = new DirectoryInfo(absolutDirectory);
            if (!_absolutDirectory.Exists)
                _absolutDirectory.Create();
            EditePageRepository.CreatePage("/Views/Article/Partial/_articleindex.cshtml", WebPages._articleindex);
        }

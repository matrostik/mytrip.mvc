...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
  ...
  if (c == "Create_news") {%><%=Mytrip_Mvc_Language_1.menu_write_news%><% }
  if (c == "Create_article")
  {%><%=Mytrip_Mvc_Language_1.menu_write_article%><%}
  if (c == "Create_post")
  {%><%=Mytrip_Mvc_Language_1.menu_write_post%><%}%>
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
<!--/*   Mytrip.Mvc.Web.Linq2sql   Copyright ©  2009 Стюхин Олег Анатольевич   */-->
<%string c = ViewData["create"].ToString();
  if (c == "Create_news") {%><h2><%=Mytrip_Mvc_Language_1.menu_write_news%></h2><% }
  if (c == "Create_article")
  {%>
<h2><%=Mytrip_Mvc_Language_1.menu_write_article%></h2><%}
  if (c == "Create_post")
  {%>
<h2><%=Mytrip_Mvc_Language_1.menu_write_post%></h2><%}%>
<br />

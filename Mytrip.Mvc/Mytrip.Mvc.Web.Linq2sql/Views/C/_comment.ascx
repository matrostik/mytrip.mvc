...
<% if (HttpContext.Current.User.Identity.IsAuthenticated)
       {
           ...
           {%>
<div class="edit_com"> 
<a href="<%=Url.Action("ZZ", "C", new { a = x.Id })%>"><img src="/content/images/edit.png" alt="<%=Mytrip_Mvc_Language_1.edit%>" style="border-width: 0px;" /></a><br />
<a href="<%=Url.Action("ZY", "C", new { a = x.Id })%>" onclick = "return confirm ('<%=Mytrip_Mvc_Language_1.delete_comment%>');"><img src="/content/images/delete.png" alt="<%=Mytrip_Mvc_Language_1.delete%>" style="border-width: 0px;" /></a>     
</div>
<%}
           else {

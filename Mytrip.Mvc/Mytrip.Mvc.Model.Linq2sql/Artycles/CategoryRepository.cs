...
namespace Mytrip.Mvc.Model.Linq2sql.Artycles
{
    public class CategoryRepository
    {
        ...
        /// </summary>       
        /// <returns></returns>
        public mt_artycle_category Create_blog(string a, string b)
        {

            mt_artycle_category x = new mt_artycle_category
            {
                Title = HttpContext.Current.User.Identity.Name + b,
                Path = HttpContext.Current.User.Identity.Name + StaticMethod.DecodingString(b),
                AddedDate = DateTime.Now,
                AddedBy = HttpContext.Current.User.Identity.Name,
                AddMenu = false,
                Blog = true,
        ...
        /// </summary>       
        /// <returns></returns>
        public mt_artycle_category Create_category_news(string title, bool addmenu, bool allCulture, string culture)
        {
